...
public class SysDictTypeSeedData : ISqlSugarEntitySeedData<SysDictType>
{
    ...
    public IEnumerable<SysDictType> HasData()
    {
        return new[]
        {
            ...
            new SysDictType{ Id=1300000000107, Name="代码生成数据", Code="code_gen_type", OrderNo=10, Remark="代码生成数据", Status=StatusEnum.Enable, CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
        };
    }
}