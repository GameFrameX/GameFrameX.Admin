...
public class SysDictDataSeedData : ISqlSugarEntitySeedData<SysDictData>
{
    ...
    public IEnumerable<SysDictData> HasData()
    {
        return new[]
        {
            ...
            new SysDictData{ Id=1300000000103, DictTypeId=1300000000101, Value="日期选择", Code="DatePicker", OrderNo=100, Remark="日期选择", Status=StatusEnum.Enable, CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
            new SysDictData{ Id=1300000000112, DictTypeId=1300000000101, Value="日期时间选择", Code="DateTimePicker", OrderNo=100, Remark="日期时间选择", Status=StatusEnum.Enable, CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
            new SysDictData{ Id=1300000000113, DictTypeId=1300000000101, Value="时间选择", Code="TimePicker", OrderNo=100, Remark="时间选择", Status=StatusEnum.Enable, CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
