...
using GameFrameX.Application.Service.System.DataBase.Dto;
...
namespace GameFrameX.Application.Service.System.DataBase;
...
public class SysDatabaseService : IDynamicApiController, ITransient
{
    ...
    public void CreateEntity(CreateEntityInput input)
    {
        ...
        var tContent = global::System.IO.File.ReadAllText(templatePath);
        ...
        global::System.IO.File.WriteAllText(targetPath, tResult, Encoding.UTF8);
    }
    ...
    {
        var config = App.GetOptions<DbConnectionOptions>().ConnectionConfigs.FirstOrDefault(u => u.ConfigId.ToString() == input.ConfigId);
        input.Position = string.IsNullOrWhiteSpace(input.Position) ? "GameFrameX.Core" : input.Position;
        ...
        var jsonIgnoreProperties = entityType.GetProperties().Where(p =>
            p.GetAttribute<global::System.Text.Json.Serialization.JsonIgnoreAttribute>() != null ||
    ...
    private async Task<IEnumerable<EntityInfo>> GetEntityInfos()
    {
        ...
        {
            return IsMyAttribute(global::System.Attribute.GetCustomAttributes(o, true));
        }
        ).ToArray();
