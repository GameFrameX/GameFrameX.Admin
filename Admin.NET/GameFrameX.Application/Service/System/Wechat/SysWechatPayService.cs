...
using System.IO;
using System.Text;
using GameFrameX.Application.Service.System.Wechat.Dto;
...
namespace GameFrameX.Application.Service.System.Wechat;
...
public class SysWechatPayService : IDynamicApiController, ITransient
{
    ...
    private WechatTenpayClient CreateTenpayClient()
    {
        ...
        var tenpayClientOptions = new WechatTenpayClientOptions()
        {
            ...
            MerchantCertificatePrivateKey = global::System.IO.File.Exists(cerFilePath) ? global::System.IO.File.ReadAllText(cerFilePath) : "",
