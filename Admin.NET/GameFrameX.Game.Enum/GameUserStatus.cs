...
public enum GameUserStatus
{
    ...
    /// </summary>
    [Description("待验证")] PendingVerification,

    /// <summary>
    /// 活跃
    /// 账号处于正常使用状态，玩家可以自由登录和玩游戏。
    /// </summary>
    [Description("活跃")] Active,

    /// <summary>
    /// 封禁/禁止登录
    /// 由于违反游戏规定（如作弊、滥用、违规行为等），账号被暂时或永久封禁。
    /// </summary>
    [Description("封禁")] Banned,
    ...
    /// </summary>
    [Description("安全风险")] Compromised,

    /// <summary>
    /// 审核中
    /// 账号因为可疑行为或举报正在被官方审核，可能暂时无法正常使用
    /// </summary>
    [Description("审核中")] UnderReview,

    /// <summary>
    /// 限制
    /// 账号的某些功能被限制，比如不能发言、交易等，通常是因为不良行为导致的临时惩罚。
    /// </summary>
    [Description("限制")] Limited,
}