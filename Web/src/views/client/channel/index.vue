      ...
      <el-form :model="queryParams" ref="queryForm" labelWidth="90">
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" class="mb10">
            <el-form-item>
              <el-button-group>
                <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'channel:page'"> 查询
                </el-button>
              </el-button-group>

              <el-button-group style="margin-left:20px">
                <el-button type="primary" icon="ele-Plus" @click="openAddClientChannel" v-auth="'channel:add'">
                  新增
                </el-button>
              </el-button-group>
            </el-form-item>
...
import editDialog from '/@/views/client/channel/component/editDialog.vue'
import {pageClientChannel, deleteClientChannel} from '/@/api/client/channel';
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageClientChannel(Object.assign(queryParams.value, tableParams.value));
...
// 打开新增页面
const openAddClientChannel = () => {
  editClientChannelTitle.value = '添加渠道管理';
