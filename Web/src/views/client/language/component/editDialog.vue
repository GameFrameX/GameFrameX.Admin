<template>
	<div class="clientLanguage-container">
...
<script lang="ts" setup>
	...
	import { addClientLanguage, updateClientLanguage } from "/src/api/client/language";
		...
		ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
			if (isValid) {
				...
				if (ruleForm.value.id == undefined || ruleForm.value.id == null || ruleForm.value.id == "" || ruleForm.value.id == 0) {
					await addClientLanguage(values);
				} else {
					await updateClientLanguage(values);
				}
				closeDialog();
			} else {
				ElMessage({
