  ...
  <div class="appversion-container">
        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="渠道名称">
              <el-select filterable clearable="" v-model="queryParams.channel" placeholder="请选择">
                <el-option
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="旧版本">
              <el-select filterable clearable="" v-model="queryParams.oldVersion" placeholder="请选择">
                <el-option
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="平台">
              <el-select filterable clearable="" v-model="queryParams.platform" placeholder="请选择">
                <el-option
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="新版本">
              <el-select filterable clearable="" v-model="queryParams.version" placeholder="请选择">
                <el-option
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="包名">
              <el-select filterable clearable="" v-model="queryParams.package" placeholder="请选择">
                <el-option
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="语言名称">
              <el-select filterable clearable="" v-model="queryParams.language" placeholder="请选择">
                <el-option
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" class="mb10">
            <el-form-item>
              <el-button-group>
                <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'appversion:page'"> 查询
                </el-button>
              ...
              <el-button-group style="margin-left:20px">
                <el-button type="primary" icon="ele-Plus" @click="openAddClientAppVersion" v-auth="'appversion:add'">
                  新增
                </el-button>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table
        ...
        <el-table-column prop="oldVersion" label="旧版本" width="80" show-overflow-tooltip=""/>
        <el-table-column prop="version" label="新版本" width="80" show-overflow-tooltip=""/>
        <el-table-column prop="downloadUrl" label="下载地址" width="120" show-overflow-tooltip=""/>
        ...
        <el-table-column prop="isForce" label="强制更新" width="120" show-overflow-tooltip="">
          <template #default="scope">
            <el-switch v-model="scope.row.isForce" active-text="是" inactive-text="否" disabled/>
          </template>
        </el-table-column>
        <el-table-column prop="announcement" label="公告" width="180" show-overflow-tooltip=""/>
        ...
        <el-table-column label="操作" width="140" align="center" fixed="right" show-overflow-tooltip=""
                         v-if="auth('appversion:edit') || auth('appversion:delete')">
          <template #default="scope">
            <el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditClientAppVersion(scope.row)"
                       v-auth="'appversion:edit'"> 编辑
            </el-button>
            <el-button icon="ele-Delete" size="small" text="" type="primary" @click="delClientAppVersion(scope.row)"
                       v-auth="'appversion:delete'"> 删除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <editDialog
          ref="editDialogRef"
          :title="editClientAppVersionTitle"
...
import editDialog from '/src/views/client/appversion/component/editDialog.vue'
import {pageClientAppVersion, deleteClientAppVersion} from '/@/api/client/appversion';
...
const editClientAppVersionTitle = ref("");
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageClientAppVersion(Object.assign(queryParams.value, tableParams.value));
...
// 打开新增页面
const openAddClientAppVersion = () => {
  editClientAppVersionTitle.value = '添加游戏版本管理';
  editDialogRef.value.isEditor= false;
  editDialogRef.value.openDialog({});
};

// 打开编辑页面
const openEditClientAppVersion = (row: any) => {
  editClientAppVersionTitle.value = '编辑游戏版本管理';
  editDialogRef.value.isEditor= true;
  editDialogRef.value.openDialog(row);
};

// 删除
const delClientAppVersion = (row: any) => {
  ElMessageBox.confirm(`确定要删除吗?`, "提示", {
    ...
    type: "warning",
      ...
      .then(async () => {
        await deleteClientAppVersion(row);
        handleQuery();
