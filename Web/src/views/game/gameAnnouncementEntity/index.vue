  ...
  <div class="gameAnnouncementEntity-container">
      ...
      <el-form :model="queryParams" ref="queryForm" labelWidth="90">
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" class="mb10">
            <el-form-item>
              <el-button-group>
                <el-button type="primary"  icon="ele-Search" @click="handleQuery" v-auth="'gameAnnouncementEntity:page'"> 查询 </el-button>
              ...
              <el-button-group style="margin-left:20px">
                <el-button type="primary" icon="ele-Plus" @click="openAddGameAnnouncementEntity" v-auth="'gameAnnouncementEntity:add'"> 新增 </el-button>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table
        ...
        <el-table-column label="操作" width="140" align="center" fixed="right" show-overflow-tooltip="" v-if="auth('gameAnnouncementEntity:edit') || auth('gameAnnouncementEntity:delete')">
          <template #default="scope">
            <el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditGameAnnouncementEntity(scope.row)" v-auth="'gameAnnouncementEntity:edit'"> 编辑 </el-button>
            <el-button icon="ele-Delete" size="small" text="" type="primary" @click="delGameAnnouncementEntity(scope.row)" v-auth="'gameAnnouncementEntity:delete'"> 删除 </el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
	...
	/>
      <editDialog
        ref="editDialogRef"
        :title="editGameAnnouncementEntityTitle"
...
<script lang="ts" setup="" name="gameAnnouncementEntity">
import { ref } from "vue";
...
import editDialog from '/@/views/game/gameAnnouncementEntity/component/editDialog.vue'
import { pageGameAnnouncementEntity, deleteGameAnnouncementEntity } from '/@/api/game/gameAnnouncementEntity';
...
const editGameAnnouncementEntityTitle = ref("");
...
const handleQuery = async () => {
  loading.value = true;
  let res = await pageGameAnnouncementEntity(Object.assign(queryParams.value, tableParams.value));
...
// 打开新增页面
const openAddGameAnnouncementEntity = () => {
  editGameAnnouncementEntityTitle.value = '添加游戏公告';
  editDialogRef.value.isEditor= false;
  editDialogRef.value.openDialog({});
};

// 打开编辑页面
const openEditGameAnnouncementEntity = (row: any) => {
  editGameAnnouncementEntityTitle.value = '编辑游戏公告';
  editDialogRef.value.isEditor= true;
  editDialogRef.value.openDialog(row);
};

// 删除
const delGameAnnouncementEntity = (row: any) => {
  ElMessageBox.confirm(`确定要删除吗?`, "提示", {
    ...
    type: "warning",
      ...
      .then(async () => {
        await deleteGameAnnouncementEntity(row);
        handleQuery();
