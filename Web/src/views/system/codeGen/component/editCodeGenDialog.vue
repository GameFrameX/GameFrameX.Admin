        ...
        <el-row :gutter="35">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="模块名" prop="moduleName">
              <el-select v-model="state.ruleForm.moduleName" filterable clearable class="w100">
                <el-option v-for="item in state.moduleList" :key="item.value"
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="命名空间" prop="nameSpace"
              ...
              <el-select v-model="state.ruleForm.nameSpace" filterable clearable class="w100" placeholder="命名空间">
                <el-option v-for="(item,index) in props.applicationNamespaces" :key="index" :label="item"
                           :value="item"/>
              </el-select>
            </el-form-item>
          </el-col>
